...
streamlit-test: ## Run Streamlit UI unit tests
	PYTHONPATH=apps/streamlit python3 -m unittest discover -s apps/streamlit/tests

streamlit-ui-qa: ## Run browser QA for Streamlit login and dashboard contrast
	PYTHONPATH=apps/streamlit python3 scripts/streamlit_ui_qa.py
